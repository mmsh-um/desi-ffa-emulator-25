...
# python /global/common/software/desi/users/sikandar/LSS/scripts/Combined_Emulator_AbV4_pipeline.py --mockver AbacusSummit_v4_2 --real 0 --tracer QSO --emulate y --emubeta0 1.0 --emubeta1 0.0 --deco 0 --foflinklen 0.02 --antico n --emulator_dir /global/cfs/cdirs/desi/survey/catalogs/main/mocks/FAemu_preliminary/sikandar/desi-ffa-emulator/ --galcap B
...
parser.add_argument("--base_output", help="base directory for output", default = "/global/cfs/cdirs/desi/survey/catalogs/Y1/mocks/")#default='/pscratch/sd/s/sikandar/Y1/mocks/')
...
parser.add_argument("--antico", help='use deco or not?', default = 'y')
...
for tr_i in tracer_arr:   
    ...
    file_path_new_fof = emulator_basedir + "fof_v1.0/INI_fof_lightcone_ang_%s_m%s_ll_%s_tracer_%s.txt"%(args.mockver, args.real, args.foflinklen, new_target)
    ...
    emu_pfxselprop = emulator_basedir + "emulate_bitw_v1.1/out/" + args.mockver + "/" + "FAemu_m" + str(args.real) + "_" + args.galcap + "_" + new_target + "_llen" + str(args.foflinklen) + "_beta0_" + str(args.emubeta0) + "_beta1_" + str(args.emubeta1) + "_deco_" + str(args.deco) + "_truent_cfc_"
    emu_naminqref = emulator_basedir + "emulate_bitw_v1.1/out/TrainedEmulator_Data/FAemu_data_" + args.galcap + "_" + new_target + "_llen" + str(args.foflinklen) + "_truent_cfc_antico_deco0.1_beta0_indselfrac_cfc_qm.dat"
    emu_pfxout = emulator_basedir + "emulate_bitw_v1.1/out/" + args.mockver + "/FAemu_m" + str(args.real) + "_" + args.galcap + "_" + new_target + "_llen" + str(args.foflinklen) + "_beta0_" + str(args.emubeta0) + "_beta1_" + str(args.emubeta1) + "_deco_" + str(args.deco) +  "_truent_cfc_nbits217_"   
    ...
    for i in range(len(lines)):
        ...
        elif lines[i].startswith("linklength"):
            lines[i] = f"linklength      {args.foflinklen + 'd0'}\n"
        elif lines[i].startswith("tracer"):
            lines[i] = f"tracer      '{new_target}'\n"
        elif lines[i].startswith("antico_lg"):
            if args.antico == 'y':
                antico_param = 'T'
            elif args.antico == 'n':
                antico_param = 'F'
            lines[i] = f"antico_lg      {antico_param}\n"
        elif lines[i].startswith("learn_lg"):
            lines[i] = f"learn_lg              {'F'}\n"
        


    # Write the modified content back to the same file
    file_path_new_emu = emulator_basedir + "/emulate_bitw_v1.1/INI_emulate_bitw_lightcone_ntile_%s_%s_ll_%s_beta0_%s_beta1_%s_deco_%s_tracer_%s.txt"%(args.mockver, args.real, args.foflinklen, args.emubeta0, args.emubeta1, args.deco, new_target)
    ...
    if args.emulate == 'n':
        ...
        outputfn = emulator_basedir + "fof_v1.0/log/" + args.mockver + "_fof_" + new_target + "_llen"+ args.foflinklen +"_" + args.galcap + "_m" + args.real + "_datatrain_" + new_target + ".txt"
        errorfn = emulator_basedir + "fof_v1.0/log/" + "ERR_" + args.mockver + "_fof_" + new_target + "_llen" + args.foflinklen + "_" + args.galcap + "_m" + args.real + "_datatrain_" + new_target + ".txt"
        # print(cmd_string5)
        # print(cmd_string6)
        ...
        outputfnemu = emulator_basedir + "emulate_bitw_v1.1/log/" + args.mockver + "_emu_" + new_target + "_llen"+ args.foflinklen +"_" + args.galcap + "_m" + args.real + "_beta0_" + args.emubeta0 + "_beta1_" + args.emubeta1 + "_deco_" + args.deco + "_datatrain_" + new_target + ".txt"
        errorfnemu = emulator_basedir + "emulate_bitw_v1.1/log/" + "ERR_" + args.mockver + "_emu_" + new_target + "_llen"+ args.foflinklen +"_" + args.galcap + "_m" + args.real + "_beta0_" + args.emubeta0 + "_beta1_" + args.emubeta1 + "_deco_" + args.deco + "_datatrain_" + new_target + ".txt"
        print(cmd_string7)
        print(cmd_string8)
        ...
        # WEIGHTS
        nwe = 9
        namin_fbw = emulator_basedir + "emulate_bitw_v1.1/out/" + args.mockver + "/FAemu_m" + args.real + "_" + args.galcap + "_" + new_target + "_llen"+ args.foflinklen + "_beta0_" + args.emubeta0 + "_beta1_" + args.emubeta1 + "_deco_" + args.deco +  "_truent_cfc_nbits217_" + "wemu_unformatted.dat"
        ...
        namout_bool = emucat_outdir + args.mockver + '_' + new_target + '_' + args.galcap + '_bool_tot_datatrain_m' + args.real + "_beta0_" + args.emubeta0 + "_beta1_" + args.emubeta1 + "_deco_" + args.deco +  '.bin'
        ...
        namout_tot = emu_out_dir + args.mockver + '_corr_clustering_cat_FAemu_m' + args.real + '_' + args.galcap + '_' + new_target + '_llen'+ args.foflinklen + "_beta0_" + args.emubeta0 + "_beta1_" + args.emubeta1 + "_deco_" + args.deco +  '_truent_cfc.fits'
        ...
        elif args.mockver == "AbacusSummit_v4_2":
            pathstr = "SecondGenMocks/AbacusSummit_v4_1fixran/"
        ...
        emu_in = Table.read(emu_out_dir + args.mockver + '_corr_clustering_cat_FAemu_m' + args.real + '_' + args.galcap + '_' + new_target + '_llen'+ args.foflinklen + "_beta0_" + args.emubeta0 + "_beta1_" + args.emubeta1 + "_deco_" + args.deco + '_truent_cfc.fits')
        ...
        if args.antico == 'n':
            sav_pth_str = "" #"/NoAntico/"
        elif args.antico == 'y':
            sav_pth_str = ""
        outdir_data_base = "/global/cfs/cdirs/desi/users/sikandar/Fall2024/FFA_Covariances/" + sav_pth_str + f"ll_{args.foflinklen}_beta0_{args.emubeta0}_beta1_{args.emubeta1}_deco_{args.deco}/" + "mock" + str(args.real) + "/"
        if not os.path.exists(outdir_data_base):
            os.makedirs(outdir_data_base)
            print('made ' + outdir_data_base)
        print(f"Copying to {outdir_data_base}")
        outdir_data = outdir_data_base + "ffa_full_" + target_write_name + ".fits"
