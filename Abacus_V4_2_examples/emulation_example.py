...
parser.add_argument("--output_directory_final", help='where to put final catalogs')
args = parser.parse_args()
tracer_arr = np.array(args.tracer)
tracer_string = " ".join(tracer_arr)

add_string = ""
output_directory_final = args.output_directory_final
...
for tr_i in tracer_arr:   
    ...
    if args.emulate == 'n':
        ...
        if args.antico == 'n':
            ...
            sav_pth_str = ""
        outdir_data_base = output_directory_final + sav_pth_str + f"ll_{args.foflinklen}_beta0_{args.emubeta0}_beta1_{args.emubeta1}_deco_{args.deco}/" + "mock" + str(args.real) + "/"
